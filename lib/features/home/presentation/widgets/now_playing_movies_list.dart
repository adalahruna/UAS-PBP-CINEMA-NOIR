...
class HomePage extends StatelessWidget {
                ...
                return SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // =======================================================
                      // --- PERUBAHAN DI SINI ---
                      // Header "Sedang Tayang" dipindahkan ke dalam 
                      // _buildCenteredSwipeableMovieList
                      // =======================================================
                      _buildCenteredSwipeableMovieList(
                        title: 'Sedang Tayang', // Kirim title
                        onTapSeeAll: () {}, // Kirim callback
                      ...
                      // Header "Akan Tayang" tetap di sini (tidak di tengah)
                      _buildSectionHeader(
                        title: 'Akan Tayang',
                        onTapSeeAll: () {},
                      ),
  ...
  // --- PERUBAHAN: Terima 'title' dan 'onTapSeeAll', lalu buat Column ---
  // =======================================================================
  Widget _buildCenteredSwipeableMovieList({
    ...
    return Column(
      children: [
        // 1. Panggil _buildSectionHeader dengan isCentered = true
        _buildSectionHeader(
          title: title,
          onTapSeeAll: onTapSeeAll,
          isCentered: true, // <-- Ini akan membuatnya di tengah
        ),
        const SizedBox(height: 16.0), // Jarak antara header dan poster

        // 2. Tampilkan poster list
        _HoverableMovieList(
  ...
  // =======================================================================
  // --- _buildSectionHeader ---
  // --- PERUBAHAN: Tambah parameter 'isCentered' ---
  // =======================================================================
  Widget _buildSectionHeader({
    required String title,
    required VoidCallback onTapSeeAll,
    bool isCentered = false, // <-- Parameter baru, default false
  }) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16.0),
      child: Row(
        // Ganti alignment berdasarkan parameter
        mainAxisAlignment: isCentered ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
        children: [
          // Jika tidak centered, gunakan Flexible
          if (!isCentered)
            Flexible(
              child: Text(
                title,
            ...
            // Jika centered, tampilkan teks saja
            Text(
              title,
              style: const TextStyle(
                color: AppColors.gold,
          ...
          // Beri jarak jika centered
          if (isCentered) const SizedBox(width: 16.0), 
...
// --- WIDGET ITEM FILM NOW PLAYING (DENGAN ASPECT RATIO) ---
class _NowPlayingMovieItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        child: AspectRatio(
          // Rasio aspek poster standar (sekitar 2:3)
          // 200 / 260 terlalu "gemuk", kita gunakan rasio yang lebih umum
          aspectRatio: 2 / 3, 
          child: Stack(
            children: [
              Positioned.fill(
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover, // Cover akan mengisi AspectRatio
